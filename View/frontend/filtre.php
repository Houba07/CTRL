...
if(isset($_POST['id_categorie'])){
    ...
    foreach($listelivre as $livre){if($livre['categorie']==$_POST['id_categorie']){
            ?> 
                <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <p class="button text-center"><a href="livres_pdf/<?php echo $livre['pdf_livre']; ?>" class="btn btn-tertiary px-4 py-3">Lire</a></p>
